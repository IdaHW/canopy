...
Canopy consists of two fonts; Nunito Sans and Otto ABC. Both fonts are included in the distributed Canopy package, and will load automatically when you have installed Canopy correctly.
